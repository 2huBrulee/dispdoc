...
const DisponibilidadPanel = ({rows=[],columns=[],selection=[],enabled=[],onSelect= f=>f,...props}) =>
    <Panel bsStyle="primary">
        <Panel.Heading>
            <Panel.Title componentClass="h3">Disponibilidad Horaria</Panel.Title>
        </Panel.Heading>
        <Panel.Body>
            <DisponibilidadHoraria rows={rows} columns={columns} selection={selection} enabled={enabled} onSelect={onSelect} {...props}/>
        </Panel.Body>
    </Panel>
